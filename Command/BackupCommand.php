...
class BackupCommand extends StorageCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $steps = [
            [
                'description' => 'dump database structure / create an archive of the entire project root, excluding temporary files (parallel jobs)',
